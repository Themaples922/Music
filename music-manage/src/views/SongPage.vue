<template>
  <div class="table">
    ...
    <div class="container">
      <div class="handle-box">
        ...
        <el-button size="small"
                   ...
                   style="background-color:pink;color:#fff;">添加歌曲</el-button>
      </div>
      <el-table :data="data"
                size="small"
                border
      ...
      <el-form action=""
        ...
        <el-form-item label="歌词">
          <el-input type="textarea"
                    name="lyric"
                    v-model="registerForm.lyric"></el-input>
        </el-form-item>
    ...
    <el-dialog title="编辑"
               v-model="editVisible"
               width="400px">
      <el-form ref="songForm"
               :model="songForm"
               label-width="80px">
        <el-form-item label="歌手-歌曲名"
                      size="small">
        ...
        <el-form-item label="歌词"
                      size="small">
          <el-input type="textarea"
                    v-model="songForm.lyric"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
        <span class="dialog-footer">
