  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        <el-button size="small"
                   ...
                   @click="delAll"
                   style="background-color:pink;color:#fff;">批量删除</el-button>
        ...
        <el-button size="small"
                   ...
                   style="background-color:pink;color:#fff;">添加歌单</el-button>
      </div>
      <el-table :data="data"
                border
                size="small"
        ...
        <el-table-column label="内容"
          ...
          <template v-slot="scope">
            <el-button size="small"
                       @click="getContent(data[scope.$index].id)">内容</el-button>
          </template>
        </el-table-column>
        <el-table-column label="评论"
          ...
          <template v-slot="scope">
            <el-button size="small"
                       @click="getComment(data[scope.$index].id)">评论</el-button>
          </template>
        </el-table-column>
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary"
                     size="small"
                     @click="addsongList">确 定</el-button>
        </span>
      </template>
    </el-dialog>
    ...
    <el-dialog title="编辑"
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-button size="small"
                     @click="editVisible = false">取 消</el-button>
          <el-button type="primary"
                     size="small"
    ...
    <!-- 删除提示框 -->
    <yin-del-dialog :delVisible="delVisible"
                    @deleteRow="deleteRow"
...
export default {
  ...
  methods: {
    ...
    addsongList() {
      ...
      HttpManager.setSongList(params)
        .then((res) => {
          if (res.code === 1) {
            this.getData()
            this.registerForm = {}
