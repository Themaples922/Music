    ...
    <div class="container">
      <div class="handle-box">
        ...
        <el-button size="small"
                   ...
                   style="background-color:pink;color:#fff;">添加新用户</el-button>
      </div>
      <el-table :data="data"
                border
                size="small"
        ...
        <el-table-column label="用户图片"
          ...
          <template v-slot="scope">
            <img :src="getUrl(scope.row.avatar)"
                 alt=""
                 style="width: 80px;" />
        ...
        <el-table-column label="收藏"
          ...
          <template v-slot="scope">
            <el-button size="small"
                       @click="getCollect(data[scope.$index].id)">收藏</el-button>
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    addPeople() {
      ...
      params.append('avatar', this.userPic)
