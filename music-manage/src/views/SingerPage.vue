  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        <el-button class="handle-del mr10"
                   size="small"
                   @click="delAll"
        ...
        <el-button size="small"
                   ...
                   style="background-color:pink;color:#fff;">添加歌手</el-button>
      </div>
      <el-table ref="multipleTable"
        ...
        <el-table-column label="歌曲管理"
          ...
          <template v-slot="scope">
            <el-button size="small"
                       @click="songEdit(scope.row.id, scope.row.name)">歌曲管理</el-button>
          </template>
        </el-table-column>
